    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        @media (max-width: 768px) {
            ...
            #svg-right { padding: 0px 10px; margin-top: -50px;width:100%; height:100%; display:block; }
            #svg-left { padding: 0px 10px; margin-top: -50px;width:100%; height:100%; display:block; }
        }
