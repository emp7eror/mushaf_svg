    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        @media (max-width: 768px) {
            ...
            #svg-right { padding-left: 5px; margin-top: -15px;width:100%; height:100%; display:block; }
            #svg-left { padding-left: 5px; margin-top: -15px;width:100%; height:100%; display:block; }
            .navbar {
                position: absolute;
                bottom: 50px;
                left: 0;
